/*
  ...
  - The values [WEEKDAYS] on the enum `DropoffSchedule` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DropoffSchedule_new" AS ENUM ('DAILY', 'WEEKLY');
